...
# ----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,"มาไวไปไวจริงๆบักหำ @  " + cl.getContact(op.param2).displayName + "  ลาก่อย\n～(^з^)-♡\n\n═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═")
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            ...
            cl.sendText(op.param1, "ยินดีต้อนรับไอ้บักหำ 😊 @ " + cl.getContact(op.param2).displayName + " สู่กลุ่ม " + "👉" + str(ginfo.name) + "👈""\n\n═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═")
