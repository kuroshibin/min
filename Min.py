...
helpMessage ="""KEY ═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═ =====||
...
🔥||✒️✒ แปลงร่าง @      - Copy Profile 

🔥||✒️✒ ออกร่าง @    - Backup Profile
||========================||
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,"u5d777f646c37180c939be97aa5097096"]
bot1 = cl.getProfile().mid
admsa = "u5a28d8e76adf14a9fe516112963647b0"
admin = "u5a28d8e76adf14a9fe516112963647b0"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"selt bot by\n═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═\nhttp://line.me/ti/p/~socool290\nมึงจะแอดมาทะมายแอดมารันก็หรอคับ\n",
    "lang":"JP",
...
# ----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,"มาไวไปไวจริงๆบักหำคนนี้\n\nGu Min Hack Bot   " + cl.getContact(op.param2).displayName + "  ลาก่อย\n～(^з^)-♡\n\n═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═")
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            ...
            cl.sendText(op.param1, "ยินดีต้อนรับไอ้บักหำ 😊\n\nGu Min Hack Bot  " + cl.getContact(op.param2).displayName + " สู่กลุ่ม " + "👉" + str(ginfo.name) + "👈""\n\n═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═")
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By: ═हई ௮ิЮ🔥のิঐのටଏ🔥ईह═" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#-----------------------------------------------------------
   ...
   #----------------------------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"ทำการลบทันทีลบไปแล้วตอนนี้ 1,259 กลุ่ม\n\nขนาดนี้ไม่มีต้องที่ต้องการยกเลิก\n\nGu Min Hack Bot")
                else:
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                ...
                start = time.time()
                cl.sendText(msg.to, "รอสักแป้พพพพ...")
